...
class CAR
{
	public :int vel , cp ,init , op1 , op2 , op3 , level ;
	long score ; long lev_score [5];
	char player [20];
	CAR ::CAR ()
	{
		level=1;
...
void about()
{
	...
	while(!kbhit())
	{
		for(int i=300;i<600;i++)
		{
			...
			setcolor(6);
			settextstyle(2,0,6);
			outtextxy(600-i,600-i,"Anil");
			outtextxy(i-150,215,"SIddu");
			outtextxy(i-30,i-130 ,"****" );
			outtextxy(600-i,i-150 ,"####");
			outtextxy(350,600-i ,"&&&&" );
			setfillstyle(1,4);
